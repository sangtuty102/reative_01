...
Dự án sử dụng cơ chế đa ngôn ngữ siêu việt kết hợp giữa JSON phân cấp (Nested JSON) để chia task làm việc nhóm dễ dàng, và `GetX LocaleKeys` để đảm bảo code an toàn (type-safe) chống sai chính tả.

👉 **Mời bạn xem chi tiết tại: [Tài liệu Hướng dẫn Đa ngôn ngữ (i18n)](docs/localization.md)**
